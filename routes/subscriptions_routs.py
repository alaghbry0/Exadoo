...
@public_routes.route("/notifications", methods=["GET"])
...
@public_routes.route("/notifications/unread/count", methods=["GET"])
...
@public_routes.route("/notifications/unread/count/<notification_type>", methods=["GET"])
...
@public_routes.route("/notifications/mark-as-read/<notification_type>", methods=["PUT"])
...
@public_routes.route("/notifications/<int:notification_id>", methods=["GET"])
